const { submit_Car } = require("../Service/bmw"); // Honda controller
const { display_Car } = require("../Service/bmw");
const { update_Car } = require("../Service/bmw");
const { delete_Car } = require("../Service/bmw");
