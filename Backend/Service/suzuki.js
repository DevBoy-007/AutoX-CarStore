const { submit_Car, check } = require("../Model/suzuki"); // Suzuki service
const { display_Car } = require("../Model/suzuki");
const { update_Car } = require("../Model/suzuki");
const { delete_Car } = require("../Model/suzuki");
module.exports = {
    submit_Car: async (body) => {
        try {
            ...
            if (checking.response == body.Vin) {
                return {
                    response: " this Suzuki Variant has already exist ",
                }
            }
