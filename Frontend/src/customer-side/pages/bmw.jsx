...
function BMW() {
    ...
    return (
        <>
            <section className=" bg-white flex flex-col items-center mt-4 mb-10 w-[98%] m-[auto] ">
                <h1 data-aos="zoom-in" className="flex justify-center items-center text-center bg-black w-[60%] h-[80px] text-white">
                    BMW 
                </h1>
                {car_list.length==0 && <h1 className=" shadow-2xl  text-black shadow-black mt-10 text-3xl">BMW showroom has no car-stock !</h1>}
                <motion.div
